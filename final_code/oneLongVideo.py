...
def detect_specific_landmarks(image, mp_pose, specific_landmarks_indices):
    ...
    if results.pose_landmarks:
        for landmark_idx in specific_landmarks_indices:
            if results.pose_landmarks.landmark[landmark_idx].visibility < 0.5:  # 감지하지 못한 값을 처리합니다.
                        continue
...
if __name__ == "__main__":
    # 동영상 캡쳐
    video_path = "C:\motionDetection\KakaoTalk_20240213_141802397.mp4"
    output_folder = "frames-6"
